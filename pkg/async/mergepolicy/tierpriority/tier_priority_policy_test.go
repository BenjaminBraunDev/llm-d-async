...
func TestTierPriorityStamping(t *testing.T) {
	...
	policy := NewTierPriorityPolicy("test-stamping", "x-gateway-priority", "tier")
	policy.objectiveHeader = "x-llm-d-inference-objective"
	policy.laneObjectives = map[string]string{
